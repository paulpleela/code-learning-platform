...
class Sidebar(object):
    def setupUi(self, MainWindow):
        ...
        self.enrolled_btn_1 = QPushButton(self.icon_only_widget)
        self.enrolled_btn_1.setObjectName(u"enrolled_btn_1")
        icon2 = QIcon()
        ...
        self.enrolled_btn_1.setIcon(icon2)
        self.enrolled_btn_1.setIconSize(QSize(20, 20))
        self.enrolled_btn_1.setCheckable(True)
        self.enrolled_btn_1.setAutoExclusive(True)

        self.verticalLayout.addWidget(self.enrolled_btn_1)

        self.teaching_btn_1 = QPushButton(self.icon_only_widget)
        self.teaching_btn_1.setObjectName(u"teaching_btn_1")
        icon3 = QIcon()
        ...
        self.teaching_btn_1.setIcon(icon3)
        self.teaching_btn_1.setIconSize(QSize(20, 20))
        self.teaching_btn_1.setCheckable(True)
        self.teaching_btn_1.setAutoExclusive(True)

        self.verticalLayout.addWidget(self.teaching_btn_1)
        ...
        self.enrolled_btn_2 = QPushButton(self.full_menu_widget)
        self.enrolled_btn_2.setObjectName(u"enrolled_btn_2")
        self.enrolled_btn_2.setIcon(icon2)
        self.enrolled_btn_2.setIconSize(QSize(14, 14))
        self.enrolled_btn_2.setCheckable(True)
        self.enrolled_btn_2.setAutoExclusive(True)

        self.verticalLayout_2.addWidget(self.enrolled_btn_2)

        self.teaching_btn_2 = QPushButton(self.full_menu_widget)
        self.teaching_btn_2.setObjectName(u"teaching_btn_2")
        self.teaching_btn_2.setIcon(icon3)
        self.teaching_btn_2.setIconSize(QSize(14, 14))
        self.teaching_btn_2.setCheckable(True)
        self.teaching_btn_2.setAutoExclusive(True)

        self.verticalLayout_2.addWidget(self.teaching_btn_2)
        ...
        self.enrolled_btn_1.toggled.connect(self.enrolled_btn_2.setChecked)
        self.teaching_btn_1.toggled.connect(self.teaching_btn_2.setChecked)
        ...
        self.enrolled_btn_2.toggled.connect(self.enrolled_btn_1.setChecked)
        self.teaching_btn_2.toggled.connect(self.teaching_btn_1.setChecked)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.enrolled_btn_1.setText("")
        self.teaching_btn_1.setText("")
        ...
        self.enrolled_btn_2.setText(QCoreApplication.translate("MainWindow", u"Enrolled", None))
        self.teaching_btn_2.setText(QCoreApplication.translate("MainWindow", u"Teaching", None))

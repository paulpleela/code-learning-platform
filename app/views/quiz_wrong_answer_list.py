...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        ##################
        # gridlayout.addWidget(element, row, column, rowspan -> 1 , columnspan -> 1)
        ...
        ############################
        #setColumnStrech here -> make left and right have different size
        self.gridLayout.setColumnStretch(0, 5)
        self.gridLayout.setColumnStretch(1, 1)
        self.scrollArea.setWidget(self.scrollAreaWidgetContents)
        #############################
        self.tryagain = QPushButton(Form)
        self.tryagain.setObjectName(u"tryagain")
        self.tryagain.setGeometry(QRect(30, 510, 131, 24))
    ...
    def retranslateUi(self, Form):
        ...
        self.tryagain.setText(QCoreApplication.translate("Form", u"Try again", None))
    # retranslateUi

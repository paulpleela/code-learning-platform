...
class RegisterWindow(QtWidgets.QWidget):
    ...
    def setupUi(self, RegisterWindow):
        ...
        self.name_label = QtWidgets.QLabel(parent=self.frame_4)
        self.name_label.setGeometry(QtCore.QRect(0, 0, 261, 16))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.name_label.setFont(font)
        self.name_label.setObjectName("name_label")
        self.name_input = QtWidgets.QLineEdit(parent=self.frame_4)
        self.name_input.setGeometry(QtCore.QRect(0, 20, 271, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, RegisterWindow):
        ...
        self.name_label.setText(_translate("RegisterWindow", "Full Name (for certificates)"))
        ...
        self.role_selector.setItemText(0, _translate("RegisterWindow", "I\'m a Student"))
        self.role_selector.setItemText(1, _translate("RegisterWindow", "I\'m a Teacher"))
